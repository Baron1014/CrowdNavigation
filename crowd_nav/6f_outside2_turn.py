...
class CrowdAvoidanceLeaf(RMPLeaf):
    ...
    def __init__(self, name, parent, v_detector, detector, robot, eg, idx_frame):
        ...
        def RMP_func(x, x_dot):
            ...
            _, a, _, _ = inference(x[0][0], x[1][0], x_dot, robot=robot, video_detector=v_detector, detector=detector, env_config=eg, idx_frame=idx_frame)
            x_c = a[0]
            y_c = a[1]
